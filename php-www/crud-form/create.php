    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="field">
            ...
            <div class="control"><input class="input" name="name" value="<?php echo $_POST['name']; ?>"></div>
        </div>
        <div class="field">
            <label class="label">Email</label>
            <div class="control"><input class="input" name="email" value="<?php echo $_POST['email']; ?>"></div>
        </div>
        <div class="field">
            <label class="label">Message</label>
            <div class="control">
              <textarea class="textarea" name="message" value="<?php echo $_POST['message']; ?>"></textarea>
            </div>
        </div>
        <div class="field">
            <div class="control">
